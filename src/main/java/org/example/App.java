...
public class App
{
    ...
    {
        System.setProperty(
                "webdrive.Firefox.driver", "src/main/resources/geckodriver.exe"
        );
        System.setProperty(
        ...
        WebDriver driverTest2 = new FirefoxDriver();
        driverTest2.get("https://crm.geekbrains.space");
        driverTest2.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);
